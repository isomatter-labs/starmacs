...
#+begin_src emacs-lisp
  ...
  (setq-default line-spacing 0.1)
    ...
    (defvar axiom/variable-pitch-font (if (member "Crimson Pro" (font-family-list))
                                        "Crimson Pro"
                                      "Times New Roman"))

    (defvar axiom/comment-face axiom/fixed-pitch-font)

    (defvar axiom/org-mode-code-font (if (member "DM Mono" (font-family-list))
                                       "DM Mono"
                                     axiom/fixed-pitch-font))

   (defvar axiom/title-font (if (member "Magorian" (font-family-list))
                                       "Magorian"
                                     "Baskerville"))
...
#+begin_src emacs-lisp
  (use-package org
    ...
    (set-face-attribute 'org-document-title nil :inherit '(shadow axiom/title-font) :weight 'regular :height 1.50)
    (set-face-attribute 'org-document-info nil :inherit '(shadow axiom/title-font) :weight 'regular :height 1.20)
