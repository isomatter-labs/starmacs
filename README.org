...
#+begin_src emacs-lisp
      ...
      (defvar axiom/fixed-pitch-font (if (member "Berkely Mono" (font-family-list))
                                         "Berkely Mono"
                                       "SF Mono"))
      ...
      (defvar axiom/modeline-font (if (member "Iosevka Term" (font-family-list))
                                          "Iosevka Term"
