...
#+begin_src emacs-lisp
  ...
  (setq line-spaceing 0.1)

  (defun axiom/setup-fonts ()
    (setq axiom/fixed-pitch-font (if (member "JuliaMono" (font-family-list))
                                     "JuliaMono"
                                   "Courier New"))
    ...
    (setq axiom/comment-face axiom/fixed-pitch-font)

    (setq axiom/org-mode-code-font (if (member "DM Mono" (font-family-list))
                                       "DM Mono"
...
#+begin_src emacs-lisp
  (use-package org
    ...
    (set-face-attribute 'org-block nil :foreground nil :font axiom/org-mode-code-font :inherit 'fixed-pitch :slant 'italic)
...
#+begin_src emacs-lisp
  (use-package eglot
    ...
    (setq company-backends
        (cons 'company-capf
              (remove 'company-capf company-backends))) ; move company-capf to front to ensure company is getting completions
    (add-to-list 'eglot-server-programs '(scala-mode . ("metals" "--stdio"))))
        #+end_src
