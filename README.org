...
#+begin_src emacs-lisp
  ...
  (defvar axiom/variable-pitch-font "Hubot-Sans")

  (defvar axiom/comment-face axiom/fixed-pitch-font)

  (defvar axiom/org-mode-code-font "Menlo")

  (defvar axiom/title-font "Mona Sans")


  (set-face-attribute 'default nil :font axiom/fixed-pitch-font :height axiom/fixed-pitch-height :width 'expanded)
  (set-face-attribute 'fixed-pitch nil :font axiom/fixed-pitch-font :height axiom/fixed-pitch-height :width 'expanded)
