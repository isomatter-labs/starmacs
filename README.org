...
#+begin_src emacs-lisp
  (use-package org
    ...
    (set-face-attribute 'org-document-title nil :inherit '(shadow axiom/title-font) :height 1.50)
    (set-face-attribute 'org-document-info nil :inherit '(shadow axiom/title-font) :height 1.20)

    (set-face-attribute 'org-block nil :foreground nil :font axiom/org-mode-code-font :height 120 :inherit 'fixed-pitch :slant 'italic)
