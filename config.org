...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "<escape>") 'keyboard-escape-quit)
    ...
    ;;     "<tab>" '(projectile-switch-project :which-key "Switch Project")
    ;;     "f" '(treemacs :which-key "Toggle Treemacs")
    ;;     "g" '(why-this-mode) :which-key "Toggle inline blame messages"))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun posframe-poshandler-window-top-center-offset (info)
    ...
    Get a position which lets posframe stay onto current window's top center. The structure of INFO can be found in docstring of `posframe-show'."
  ...
  (use-package ivy-posframe
    :ensure t
    :init
    (setq ivy-posframe-display-functions-alist '((counsel-M-x . ivy-posframe-display-at-frame-top-center )))
    (ivy-posframe-mode 1))
